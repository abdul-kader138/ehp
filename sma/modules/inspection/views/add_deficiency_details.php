...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=inspection&view=add_deficiency_details", $attrib);?>
<div class="control-group">
    <label class="control-label" for="code"><?php echo $this->lang->line("details_code"); ?></label>
    <div class="controls"> <?php echo form_input('details_code', $rnumber, 'class="span4" readonly="readonly" id="details_code" required="required" pattern="[a-zA-Z0-9_-()]{2,12}" data-error="'.$this->lang->line("details_code").' '.$this->lang->line("is_required").' '.$this->lang->line("min_2").'"');?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo form_textarea('details_comment', (isset($_POST['details_comment']) ? $_POST['details_comment'] : ''), 'class="input-block-level" data-error="' . $this->lang->line("details_comment") . ' ' . $this->lang->line("is_required") . ' ' . $this->lang->line("min_10") . '" rows="5" cols="5" id="location" style="margin: 10px 0px 0px; height: 106px; width: 415px;"'); ?>
    </div>
</div>
<div class="control-group">
    <div class="controls"> <?php echo form_submit('submit', $this->lang->line("add_deficiency_details"), 'class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?> 
