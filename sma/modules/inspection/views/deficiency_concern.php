<script>
    $(document).ready(function() {
        $('#fileData').dataTable( {
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
            'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=inspection&view=getDataTableAjaxForConcernDetails',
...
<p><a href="<?php echo site_url('module=inspection&view=add_deficiency_concern');?>" class="btn btn-primary"><?php echo $this->lang->line("add_deficiency_concern"); ?></a></p>
