...
$(document).ready(function () {
    ...
    newTr.html('<td><input name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" style="text-align:left;" name="item' + count + '" type="text" value="' + item_name + ' (' + item_code + ')"></td><td><input class="input-block-level text-center" type="text" readonly="readonly"   name="item_um' + count + '" value="' + item_um + '" id="item_um-' + count + '" /></td><td><input class="input-block-level text-center" name="quantity' + count + '" id="qnt_' + count + '" type="text" value="1" onkeyup="getSubtottal(' + count + ')" onClick="this.select();"></td><td><i class="icon-trash tip del" id="' + count + '" title="Remove this Item" style="cursor:pointer;" data-placement="right"></i></td>');
...
echo form_open("module=settings&view=add_pck", $attrib);
?>
...
<div class="control-group">
    ...
    <div
        class="controls"> <?php echo form_input('package_name', (isset($_POST['package_name']) ? $_POST['package_name'] : ""), 'class="span4 tip" id="reference_no" required="required" data-error="' . $this->lang->line("package_name") . ' ' . $this->lang->line("is_required") . '"'); ?> </div>
</div>
...
<div class="control-group">
    <label class="control-label">Package Items</label>
