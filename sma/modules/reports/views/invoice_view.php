...
<h3 class="title">Create Invoice</h3>
...
<div class="control-group">
    ...
    <div class="controls"> <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : ""), 'class="span4" required="required" data-error="Start date is required" id="start_date"');?> </div>
</div>
<div class="control-group">
    <label class="control-label" for="end_date"><?php echo $this->lang->line("end_date"); ?></label>
    <div class="controls"> <?php echo form_input('end_date', (isset($_POST['end_date']) ? $_POST['end_date'] : ""), 'class="span4" required="required" data-error="End date is required"  id="end_date"');?> </div>
</div>


<div class="control-group">
    <div class="controls"> <?php echo form_submit('submit', "Add", 'class="btn btn-primary"');?> </div>
</div>
<?php echo form_close();?>
