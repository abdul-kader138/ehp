...
<div class="control-group">
    ...
    <div class="controls"> <?php echo form_input('buildings_code', $buildings->building_code, 'class="span4" id="buildings_code" required="required" pattern="[a-zA-Z0-9_-]{2,12}" data-error="'.$this->lang->line("code").' '.$this->lang->line("is_required").' '.$this->lang->line("min_2").'"');?> </div>
</div>
<div class="control-group">
