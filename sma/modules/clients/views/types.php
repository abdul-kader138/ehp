<script>
    $(document).ready(function() {
        $('#fileData').dataTable( {
            ...
            'bProcessing'    : true,
            'bServerSide'    : true,
            'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=clients&view=getdatatableajax',
...
<table id="fileData" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
    <thead>
    <tr>
        <th><?php echo $this->lang->line("type_code"); ?></th>
...
<p><a href="<?php echo site_url('module=clients&view=add_type');?>" class="btn btn-primary"><?php echo $this->lang->line("new_type"); ?></a></p>
